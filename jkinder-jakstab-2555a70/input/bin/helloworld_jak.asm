...
0x0040100f:	call	0x00401030	; targets: 0x00401030(MAY)
0x00401014:	subl	$0x1, %ebx	; from: 0x00401063(MAY)
0x00401017:	jne	0x0040100a	; targets: 0x00401019(MAY), 0x0040100a(MAY)
0x00401019:	call	%edi	; targets: 0x00401023(MAY)	; from: 0x00401017(MAY)
0x0040101b:	pushl	$0x0	; from: 0x0040102d(MAY)
0x0040101d:	call	0x004010a6	; targets: 0x004010a6(MAY)
0x00401023:	pushl	$0x40301c	; from: 0x00401019(MAY)
0x00401028:	call	0x00401030	; targets: 0x00401030(MAY)
0x0040102d:	ret	; targets: 0x0040101b(MAY)	; from: 0x00401063(MAY)
...
0x00401038:	call	0x004010ac	; targets: 0x004010ac(MAY)
0x0040103d:	movl	%eax, -4(%ebp)
0x00401040:	pushl	0x8(%ebp)
0x00401043:	call	0x00401070	; targets: 0x00401070(MAY)
...
0x0040105a:	call	0x004010b2	; targets: 0x004010b2(MAY)
0x0040105f:	movl	-8(%ebp), %eax
0x00401062:	leave	
0x00401063:	ret	$0x4	; targets: 0x00401014(MAY), 0x0040102d(MAY)
...
0x00401095:	jne	0x0040109d	; targets: 0x00401097(MAY), 0x0040109d(MAY)
...
0x004010a1:	popl	%ebx
0x004010a2:	ret	$0x4	; targets: 0x00401048(MAY)

0x004010a6:	jmp	ExitProcess@kernel32.dll	; targets: 0xff000020(MAY)	; from: 0x0040101d(MAY)
0x004010ac:	jmp	GetStdHandle@kernel32.dll	; targets: 0xff000030(MAY)	; from: 0x00401038(MAY)
0x004010b2:	jmp	WriteFile@kernel32.dll	; targets: 0xff000010(MAY)	; from: 0x0040105a(MAY)
